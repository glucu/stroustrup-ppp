...
/* COMMENT:
 * A result that cannot be represented as an int sounds like an overflow
 * problem. I decided to use the type 'long long' to be able to hold
 * larger values.
 */
...
long long sum_of_N(const std::vector<int> &elements, const int N) {
