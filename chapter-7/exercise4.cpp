 ...
 *
 * The get_value(), set_value(), is_declared(), and declare_name() functions all 
 * operate on the global variable var_table. Define a class called Symbol_table with 
 * a member var_table of type vector<Variable> and member functions get(), set(), is_declared(), 
